...
var runGalen = function (stream, cb, galenPath, mode, file, cwd, opt, properties) {
    ...
    args.push('-Dwebdriver.chrome.driver=' + path.resolve(__dirname + '/../node_modules/chromedriver/bin/chromedriver'));
    args.push('-Dwebdriver.gecko.driver=' + path.resolve(__dirname + '/../node_modules/geckodriver/bin/geckodriver'));
